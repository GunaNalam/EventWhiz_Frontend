    ...
    <div className="container-fluid">
      ...
      >
        ...
        <div className="row">
          ...
          <img src="https://cdn.dribbble.com/users/1602563/screenshots/8869646/media/ddc33ce2c8e2570c410123f375e2c35c.gif" alt="" className='img-fluid image-gif' />
            </div>
            <div className="ms-2 pt-2 col-3">
                <div className="form-group">
                    ...
                    <textarea name="" id="" className="form-control mb-4" rows={'5'} placeholder="MESSAGE"></textarea>
                    <button className="btn-12 mb-4"><span>SEND MESSAGE</span></button>
                </div>
            </div>
        </div>
      </div>
