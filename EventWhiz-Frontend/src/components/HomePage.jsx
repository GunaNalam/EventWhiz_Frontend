...
import "./HomePage.css";
import Image1 from"./image35.png";
import Image2 from"./image36.png";
            ...
            <Navbar />
              <div className="HomeBody">
                <div className="HomeWelcome">
                  ...
                  <div className="row">
                    <div className="col-2 text-end"><img src={Image1} alt="" className="HomeWelcomeSubImage1"  height={'372px'}/></div>
                    <div className="col-3 text-end"><img src={Image2} alt="" className="HomeWelcomeSubImage2"  height={'350px'}/></div>
              ...
              <div className="container container-SubBody">
                ...
                Uncover a world of extraordinary experiences and create memories that will last a lifetime. From exhilarating concerts to captivating workshops, we have something for every soul to cherish. Dive into a curated selection of events, effortlessly plan your next adventure, and let <span className="EventWhizTitle">EventWhiz</span> be your guide to unforgettable moments.
                </div> 
